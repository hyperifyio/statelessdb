...
func TestJsonSerializer_SerializeBasicTypes_String(t *testing.T) {
	serializer := encryptions.NewJsonSerializer[string]("string")
...
func TestJsonSerializer_SerializeBasicTypes_Int(t *testing.T) {
	serializer := encryptions.NewJsonSerializer[int]("int")
...
//	serializer := encryptions.NewJsonSerializer[chan int]()
//
